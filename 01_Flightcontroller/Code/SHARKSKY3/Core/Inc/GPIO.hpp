...
public:
	...
	static void WRITE(GPIO_TypeDef* gpio, uint8_t pin, bool pinState);
	static bool READ(GPIO_TypeDef* gpio, uint8_t pin);

	static void INTERRUPT_INIT(GPIO_TypeDef* gpio, uint8_t pin);
};
