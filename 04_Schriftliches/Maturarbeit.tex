...
Die Idee des Quadrocopters ist eine weiterführung eines Projektes aus der Robotik. Damals wurde noch ein Raspberry Pi benutzt. Da der ein Betriebsystem paralell zum Flightcontroller am laufen hat, war die Regelung nicht in Echtzeit und so zu langsam ist. Desswegen wird auch ein neuer Chip evaluiert der, kein Betriebsystem nebenbei am laufen hat. \\ \\
\iffalse
